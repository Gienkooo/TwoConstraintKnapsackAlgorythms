...
/**
 * @brief Oblicza współczynnik opłacalności przedmiotu.
 * @param tab Tabela z wartościami, wagami i rozmiarami
 * @param idx Indeks przedmiotu
 * @return Współczynnik opłacalności
 */
...
/**
 * @brief Sortuje przedmioty malejąco według opłacalności (quicksort).
 * @param tab Tabela z wartościami, wagami i rozmiarami
...
int greedyKnapsack(int n, int maxW, int maxS, vector<int> weights,
                   vector<int> sizes, vector<int> values) {
